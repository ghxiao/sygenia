...
public class ELHIOParser {
	 ...
	 * @throws Exception
	 */
	public static Clause getQueryFromFile(String path) throws Exception{
	...
	public static Clause parseQuery(String inputQuery){
		ConjunctiveQueriesParser parser;
		byte currentBytes[] = inputQuery.getBytes();
